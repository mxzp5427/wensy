...
<head>
    <meta charset="UTF-8">
    <title><?php echo ($meta_title); ?>|ASION管理平台</title>
...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">导航别名<span class="check-tips">（导航英文名称或其他）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="alias" value="<?php echo ((isset($info["alias"]) && ($info["alias"] !== ""))?($info["alias"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
        ...
        <div class="cont-ft">
            <div class="copyright">
                <div class="fl">技术支持<a href="http://www.hzasion.cn" target="_blank">杭州亚迅</a></div>
                <div class="fr"></div>
            </div>
        </div>
    </div>
