...
<body>
   <header id="header">      
        ...
        <div class="container">
            <div class="main-slider">
                <div class="slide-text">
                    <h1>Welcome to Enjoy English studio</h1>
                    <p>Boudin doner frankfurter pig. Cow shank bresaola pork loin tri-tip tongue venison pork belly meatloaf short loin landjaeger biltong beef ribs shankle chicken andouille.</p>
                    <!--<a href="#" class="btn btn-common">SIGN UP</a>-->
                </div>
                <img src="/Public/Home/singlecolor/images/home/slider/slide1/house.png" class="img-responsive slider-house" alt="slider image">
                <img src="/Public/Home/singlecolor/images/home/slider/slide1/circle1.png" class="slider-circle1" alt="slider image">
                <img src="/Public/Home/singlecolor/images/home/slider/slide1/circle2.png" class="slider-circle2" alt="slider image">
                <img src="/Public/Home/singlecolor/images/home/slider/slide1/cloud1.png" class="slider-cloud1" alt="slider image">
                <img src="/Public/Home/singlecolor/images/home/slider/slide1/cloud2.png" class="slider-cloud2" alt="slider image">
                <img src="/Public/Home/singlecolor/images/home/slider/slide1/cloud3.png" class="slider-cloud3" alt="slider image">
                <img src="/Public/Home/singlecolor/images/home/slider/slide1/sun.png" class="slider-sun" alt="slider image">
                <img src="/Public/Home/singlecolor/images/home/cycle.png" class="slider-cycle" alt="">
            </div>
        </div>
                ...
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms">
                            <img src="/Public/Home/singlecolor/images/home/icon1.png" alt="">
                        </div>
                ...
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="600ms">
                            <img src="/Public/Home/singlecolor/images/home/icon2.png" alt="">
                        </div>
                ...
                <div class="col-sm-4 text-center padding wow fadeIn" data-wow-duration="1000ms" data-wow-delay="900ms">
                    <div class="single-service">
                        <div class="wow scaleIn" data-wow-duration="500ms" data-wow-delay="900ms">
                            <img src="/Public/Home/singlecolor/images/home/icon3.png" alt="">
                        </div>
    ...
    <section id="action" class="responsive" style="display:none;">
            ...
            <div class="row">
                <div class="single-features">
                    <div class="col-sm-5 wow fadeInLeft" data-wow-duration="500ms" data-wow-delay="300ms">
                        <img src="/Public/Home/singlecolor/images/home/image1.png" class="img-responsive" alt="">
                    </div>
                ...
                <div class="single-features">
                    ...
                    <div class="col-sm-5 wow fadeInRight" data-wow-duration="500ms" data-wow-delay="300ms">
                        <img src="/Public/Home/singlecolor/images/home/image2.png" class="img-responsive" alt="">
                    </div>
                </div>
                <div class="single-features">
                    <div class="col-sm-5 wow fadeInLeft" data-wow-duration="500ms" data-wow-delay="300ms">
                        <img src="/Public/Home/singlecolor/images/home/image3.png" class="img-responsive" alt="">
                    </div>
                    <div class="col-sm-6 wow fadeInRight" data-wow-duration="500ms" data-wow-delay="300ms">
                        <h2>Experienced and Enthusiastic</h2>
