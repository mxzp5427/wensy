 ...
 * @return string         分类信息
 */
function get_category($id, $field = null, $type = 'article'){
    static $list;
...
/* 根据ID获取分类标识 */
function get_category_name($id, $type = 'article'){
    return get_category($id, 'name', $type);
}

/* 根据ID获取分类名称 */
function get_category_title($id, $type = 'article'){
...
function think_send_mail($to, $name, $subject = '', $body = '', $attachment = null){
    ...
    return  $mail->Send() ? true : var_dump($mail->ErrorInfo);
}
